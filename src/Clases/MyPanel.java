...
public class MyPanel extends JPanel {
    ...
    private MiMonito cebolla, tomate, lechuga, mayonesa, condimentos, salchicha, pan, persona, persona2, tocino, calentar, guisar;
    ...
    public MyPanel() {
        ...
        cancelar = new JButton("Reset tiempo");
        cancelarC = new JButton("Reset cantidades");
        ...
        stop.setBounds(550, 245, 80, 20);
        reset.setBounds(15, 10, 150, 20);
        ...
        jcomp22.setBounds(305, 200, 135, 25);
        inputCantidad.setBounds(440, 195, 100, 25);
        jcomp25.setBounds(270, 310, 190, 25);
        ...
        cancelar.setBounds(165, 485, 130, 25);
